...
const wordSets = {
    clashroyale: [
        'Archer', 'Archer Queen', 'Baby Dragon', 'Balloon', 'Bandit', 'Barbarians', 'Bats', 'Battle Healer', 'Battle Ram', 'Berserker', 'Bomber', 'Boss Bandit', 'Bowler', 'Cannon Cart', 'Dark Prince', 'Dart Goblin', 'Electro Dragon', 'Electro Giant', 'Electro Spirit', 'Electro Wizard', 'Elite Barbarians', 'Elixir Golem', 'Executioner', ' Firecracker', 'Fire Spirit', 'Fisherman', 'Flying Machine', 'Furnace', 'Giant', 'Giant Skeleton', 'Goblin Giant', 'Goblin Gang', 'Goblin Demolisher', 'Goblin Machine', 'Goblins', 'Goblinstein', 'Golden Knight', 'Golem', 'Guards', 'Hog Rider', 'Hunter', 'Heal Spirit', 'Ice Golem', 'Ice Spirit', 'Ice Wizard', 'Inferno Dragon', 'Knight', 'Lava Hound', 'Little Prince', 'Lumberjack', 'Magic Archer', 'Mega Knight', 'Mega Minion', 'Mighty Miner', 'Miner', 'Mini Pekka', 'Minion Horde', 'Minions', 'Monk', 'Mother Witch', 'Musketeer', 'Night Witch', 'Pekka', 'Pheonix', 'Prince', 'Princess', 'Ram Rider', 'Rascals', 'Royal Ghost', 'Royal Giant', 'Royal Hogs', 'Royal Recruits', 'Rune Giant', 'Skeleton Army', 'Skeleton Barrel', 'Skeleton Dragons', 'Skeleton King', 'Skeletons', 'Sparky', 'Spear Goblins', 'Spirit Empress', 'Three Musketeers', 'Valkayrie', 'Wall Breakers', 'Witch', 'Wizard', 'Zappies', 'Bomb Tower', 'Cannon', 'Inferno Tower', 'Mortar', 'Tesla', 'X-bow', 'Barbarian Hut', 'Elixir Collector', 'Goblin Cage', 'Goblin Drill', 'Goblin Hut', 'Tombstone', 'Arrows', 'Barb Barrel', 'Fireball', 'Freeze', 'Giant Snowball', 'Goblin Curse', 'Lightning', 'Poison', 'Rage', 'Rocket', 'Royal Delivery', 'Log', 'Tornado', 'Vines', 'Void', 'Zap',
    ],
    movies: [
